...
class DataStore {
  ...
  private seed() {
    // Create demo users
    const alice = this.createUser('alice', 'alice@university.edu', 'password123');
    alice.role = 'admin';
    alice.reputation = 85;
    alice.classification = 'Contributor';

    const bob = this.createUser('bob', 'bob@university.edu', 'password123');
    bob.reputation = 45;
    bob.classification = 'Contributor';

    const charlie = this.createUser('charlie', 'charlie@university.edu', 'password123');
    charlie.reputation = 20;
    charlie.classification = 'Neutral';

    const diana = this.createUser('diana', 'diana@university.edu', 'password123');
    diana.reputation = 10;
